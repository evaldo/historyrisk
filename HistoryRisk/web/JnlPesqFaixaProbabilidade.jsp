...
<%
    ...
    List<FaixaProbabilidade> faixasProbabilidade = se.pesquisar(cmpPesquisa);
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td align="right"><a href="JnlAltFaixaProbabilidade.jsp?opcao=alterar&idFaixaProb=<%=faixaProbabilidade.getIdFaixaProb()%>&dsFaixaProb=<%=faixaProbabilidade.getDsFaixaProb()%>&nuLmteInfr=<%=faixaProbabilidade.getNuLmteInfr()%>&nuLmteSupr=<%=faixaProbabilidade.getNuLmteSupr()%>"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></td>
