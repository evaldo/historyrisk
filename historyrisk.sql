...
SHOW WARNINGS;
CREATE INDEX `IX_FAIXA_PROB1` ON `historyrisk`.`TB_HRSK_RISCO` (`ID_FAIXA_PROB` ASC);

SHOW WARNINGS;
CREATE INDEX `IX_FAIXA_PROB2` ON `historyrisk`.`TB_HRSK_RISCO` (`ID_CATG_RISCO` ASC);

SHOW WARNINGS;
CREATE INDEX `IX_FAIXA_PROB3` ON `historyrisk`.`TB_HRSK_RISCO` (`ID_NIVEL_IPCTO` ASC);

SHOW WARNINGS;

-- -----------------------------------------------------
-- Table `historyrisk`.`TB_HRSK_PRJT_RISCO`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `historyrisk`.`TB_HRSK_PRJT_RISCO` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `historyrisk`.`TB_HRSK_PRJT_RISCO` (
  `ID_HRSK_RISCO` INT NOT NULL,
  `ID_HRSK_PRJT` INT NOT NULL,
  CONSTRAINT `FK_PRJT_RISCO_01`
    FOREIGN KEY (`ID_HRSK_RISCO`)
    REFERENCES `historyrisk`.`TB_HRSK_RISCO` (`ID_HRSK_RISCO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_RISCO_PRJT_RISCO_02`
...
SHOW WARNINGS;
CREATE INDEX `IX_HRSK_PRJT_RISCO1` ON `historyrisk`.`TB_HRSK_PRJT_RISCO` (`ID_HRSK_RISCO` ASC);

SHOW WARNINGS;
CREATE INDEX `IX_HRSK_PRJT_RISCO2` ON `historyrisk`.`TB_HRSK_PRJT_RISCO` (`ID_HRSK_PRJT` ASC);
...
START TRANSACTION;
USE `historyrisk`;
INSERT INTO `historyrisk`.`TB_HRSK_PRJT` (`ID_HRSK_PRJT`, `ID_SETOR_EMPR`, `DS_PRJT`) VALUES (1, 1, 'PROJETO DE SOFTWARE XPTO');
